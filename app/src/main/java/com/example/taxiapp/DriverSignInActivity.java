...
public class DriverSignInActivity extends AppCompatActivity {
    ...
    private boolean validateEmail() {
        ...
        String emailInput = textInputEmail.getEditText().getText().toString().trim(); //trim obrezat vse probeli
    ...
    private boolean validateName() {
        ...
        String nameInput = textInputName.getEditText().getText().toString().trim(); //trim obrezat vse probeli
    ...
    private boolean validatePassword() {
        ...
        String passwordInput = textInputPassword.getEditText().getText().toString().trim(); //trim obrezat vse probeli
        String confirmPasswordInput = textInputConfirmPassword.getEditText().getText().toString().trim(); //trim obrezat vse probeli
    ...
    public void toggleLoginSignUp(View view) {
        ...
        if (isLoginModeActive){
            ...
            toggleLoginSignUpTextView.setText("Or, login");
